...
public class QuartzRecipeCategory implements IRecipeCategory<SimpleItemRecipe> {
    public static final ResourceLocation UID =
            ResourceLocation.fromNamespaceAndPath(KisekiLegend.MOD_ID, "quartz");
    public static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(KisekiLegend.MOD_ID,
                    "textures/item/defense_1.png");
    ...
    public QuartzRecipeCategory(IGuiHelper helper) {
    ...
    public Component getTitle() {
        return Component.translatable("category.kisekilegend.quartz");
    }
