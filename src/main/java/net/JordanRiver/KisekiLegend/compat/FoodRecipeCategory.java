...
public class FoodRecipeCategory implements IRecipeCategory<SimpleItemRecipe> {
    public static final ResourceLocation UID =
            ResourceLocation.fromNamespaceAndPath(KisekiLegend.MOD_ID, "foods");
    public static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(KisekiLegend.MOD_ID,
                    "textures/item/pot_o_meat.png");
    ...
    public FoodRecipeCategory(IGuiHelper helper) {
    ...
    public Component getTitle() {
        return Component.translatable("category.kisekilegend.foods");
    }
